				...
				<UContainer class=" h-full">
					<div class="w-full h-full flex justify-between items-center">
						<div class="">
							...
							<div class="py-8 px-10 rounded bg-primary-gray-light dark:bg-primary-gray-dark shadow-md text-white w-full md:w-[40rem] h-auto">
								<div class="flex justify-between items-center">
									<div class="flex flex-col">
										<span class="text-xl font-bold">قیمت {{ systemHelp?.currency?.cName }} (24 ساعت)</span>
										<span class="text-sm font-normal mt-2">قیمت {{ systemHelp?.currency?.cName }} <span
											v-if="liveCoin"
											dir="ltr"
											class="font-bold"
									...
									<div>
										<UButton
											size="lg"
											class="text-base font-medium px-6 py-2 text-nowrap"
								...
								<div class="text-4xl font-black py-4 pt-6">
									<span
										v-if="liveCoin"
										dir="ltr"
