const persian = {
	...
	one: 'یک',
	two: 'دو',
	level1Authentication: 'احراز هویت سطح۱',
	...
	twoStepLoginPageText: 'نرم افزار Google Authenticator یک ابزار رمز عبور متغییر است. پس از اتصال، هر  ۶۰ ثانیه یک کد تأیید تولید می شود. این کد تأیید می تواند به عنوان یک تأیید امنیتی در هنگام ورود به سیستم، عملیات بانکی و حسابداری، تغییر تنظیمات امنیتی و سایر عملیات استفاده شود.',
	stepOne: 'گام۱',
	stepTwo: 'گام۲',
	stepThree: 'گام۳',
	stepFour: 'گام۴',
