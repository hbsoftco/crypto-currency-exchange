const persian = {
	...
	yourLevel: 'سطح شما',
	dollarSpotMarketFee: 'کارمزد بازار دلاری اسپات',
	tomanSpotMarketFee: 'کارمزد بازار تومانی اسپات',
	dollarFuturesMarketFee: 'کارمزد بازار دلاری فیوچرز',
	...
	api: 'API',
	bitlandApproval: 'تاییدیه بیت‌لند',
	...
	totalNumberTransactions: 'تعداد کل',
	totalVolumeTransactions: 'حجم کل',
	dollarValueTransactions: 'ارزش دلاری',
	thirtyDaysHavePassed: '30 روزه گذشته',
	ninetyDaysHavePassed: '90 روزه گذشته',
	oneHundredEightyDaysHavePassed: '180 روزه گذشته',
	...
	addMarkets: 'بازارهای انتخاب شده',
	availableMarkets: 'بازارهای در دسترس',
	type: 'نوع',
	...
	userLevel1: 'سطح یک کاربری',
	userLevel2: 'سطح دو کاربری',
	...
	globalChart: 'نمودار دلاری',
	bitlandChart: 'نمودار تومانی',
	info: 'Info',
	...
	orderNumber: 'ایدی سفارش',
	transactionNumber: 'ایدی معامله',
	...
	family: 'نام خانوادگی',
	nationalID: 'کد ملی',
	nationalID10Char: 'کد ملی ۱۰ رقمی',
	...
	disableTwoStepLogin: 'غیرفعال سازی ورود دومرحله‌ای 2FA',
	...
	save: 'ذخیره',
	manageWhiteListIp: 'لیست IP‌های مجاز (با کاما جدا کنید) ',
	listAllowedIps: 'لیست IP های مجاز',
	listAllowedIpsWithComma: 'لیست IP‌های مجاز (با کاما جدا کنید) ',
	...
	scanCodeTitle: 'به نرم افزار بیت لند بروید و کد  QR را اسکن کنید به صورت خودکار وارد حساب کاربری خود شوید.',
	...
	countrySelected: 'کشور محل سکونت',
	birthCountrySelected: 'کشور محل تولد',
	...
	coin: 'ارز',
	depositCrypto: 'واریز ارزی',
	withdrawCrypto: 'برداشت ارزی',
	depositRial: 'واریز تومان',
	withdrawRial: 'برداشت تومان',
	banking: 'امور بانکی',
	rewardsBonuses: 'جوایز و بونس‌ها',
	depositWithdrawHistory: 'تاریخچه واریز و برداشت',
	buyCryptoGuide: 'راهنمای خرید ارز',
	notifications: 'اطلاعیه‌ها',
	marketStats: 'وضعیت آماری بازار',
	myFriends: 'دوستان من',
	transferToWallet: 'انتقال ارز دیجیتال به کیف پول',
	transferToExternalAccount: 'انتقال ارز دیجیتال به حساب خارجی',
	addRialBalance: 'افزودن موجودی ریالی به حساب کاربری',
	transferToBank: 'انتقال موجودی ریالی به حساب بانکی',
	transactionCosts: 'هزینه‌های معاملات و تراکنش‌ها',
	systemAnalysis: 'آنالیزهای سیستمی از سود و زیان معاملات شما',
	manageDepositAccounts: 'مدیریت حساب‌ها و شناسه های واریز ریالی',
	createAccessKeys: 'ایجاد کلیدهای دسترسی برای توسعه‌دهندگان و برنامه نویسان',
	instantCryptoTrade: 'خرید و فروش فوری ارز دیجیتال با قیمت بازار',
	userActivityIncentives: 'تشویق‌هایی که برای فعالیت کاربران درنظر گرفته شده است',
	transactionsDetails: 'مشاهده جزئیات انتقالات ارزی یا ریالی حساب',
	userLevelDetails: 'سطح بندی کاربران بیتلند و جزئیات وضعیت من',
	howToBuyCrypto: 'چطور بیتکوین و یا هر ارزی را بخریم',
	...
	totalSupply: 'کل عرضه',
	scanCodeToLogin: 'کاربر گرامی، لطفا با یکی از دستگاه‌هایی که از قبل لاگین کرده‌اید این کد را اسکن نمایید تا به سادگی لاگین شوید!',
	...
	device: 'دستگاه',
	userLevelTopDescription: 'سطح کارمزد معاملات بر اساس حجم معامله‌های ۹۰ روز گذشته شما در هر پایه بازار محاسبه می‌شود.',
	...
	always: 'همیشگی',
	activeTo30Days: '30 روزه',
	activeTo90Days: '90 روزه',
	activeTo180Days: '180 روزه',
	...
	depositMethod: 'انتخاب روش واریز',
	selectDepositMethod: 'لطفا روش واریز خود که شامل واریز با درگاه بانکی و یا واریز با شناسه می باشد را انتخاب کنید.',
	referenceDepositDescription: 'بعد از دریافت شناسه واریز، مبلغ دلخواهتان را از طریق ساتنا، پایا و یا حساب به حساب به حساب بانکی معرفی شده با درج شناسه واریز نمایید.',
	referenceDeposit: 'واریز با شناسه',
	cardDepositDescription: 'بعد از انتخاب شماره کارت و مبلغ به درگاه شاپرک منتقل می شوید که بعد از وارد کردن مشخصات پرداخت انجام میشود.',
	cardDeposit: 'واریز با کارت بانکی',
	offline: 'آفلاین',
