...
import type { StoreOrderStopLimitDto } from '~/types/definitions/spot.types';
...
const orderMarketParams = ref<StoreOrderStopLimitDto>({
...
const finalSubmit = async () => {
	try {
		...
		await spotRepo.storeOrderStopLimit(orderMarketParams.value);
