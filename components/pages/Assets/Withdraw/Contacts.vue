						...
						>
							...
							<tbody>
								<tr
									...
									:key="row.contactUID"
									class="py-3 cursor-pointer border-b border-b-primary-gray-light dark:border-b-primary-gray-dark last:border-none odd:bg-hover2-light dark:odd:bg-hover2-dark even:bg-background-light dark:even:bg-background-dark"
...
interface EmitDefinition {
	...
	(event: 'selectedItem', value: Contact): void;
}
...
const itemSelected = (item: Contact) => {
