<template>
	<div class="p-6 w-full md:w-[25.5rem] bg-background-light dark:bg-background-dark rounded-md">
		...
		<div>
			<p class="mt-6 text-sm font-normal text-justify text-primary-yellow-light dark:text-primary-yellow-dark">
				{{ $t('tomanWithdrawalPonitOne') }}
			</p>
			<p class="mt-6 text-sm font-normal text-justify">
				{{ $t('tomanWithdrawalPonitTwo') }}
			</p>
		</div>
