			...
			>
				...
				>
					...
					<div class="w-full">
						...
						<div class="text-left mt-6 px-4 py-3 bg-primary-gray-light dark:bg-primary-gray-dark rounded-md">
							<div>
								<span class="text-sm font-normal text-subtle-text-light dark:text-subtle-text-dark ">{{ $t('IPs') }}:</span>
							</div>
							<div>
								<span class="text-sm font-bold mt-4">{{ useNumber('1.1.1.1, 12.13.14.15, 31.32.33.34 ,1.1.1.1, 12.13.14.15, 31.32.33.34, 1.1.1.1, 12.13.14.15, 31.32.33.34') }}</span>
							</div>
						</div>
						<div>
							<div class="my-8">
