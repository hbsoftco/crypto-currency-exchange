...
const footerItems = [
	{
		...
		subItems: [
			...
			{ name: useT('rulesRegulations'), url: '/privacy-policy' },
			{ name: useT('riskAgreement'), url: '/risk-agreement' },
			{ name: useT('news'), url: '#' },
			{ name: useT('userAnalysis'), url: '#' },
		],
	},
	{
		title: 'services',
		subItems: [
			{ name: useT('buyCryptocurrency'), url: '#' },
			{ name: useT('bitlandSoftware'), url: '#' },
			{ name: useT('fees'), url: '#' },
			{ name: useT('specialCustomersClub'), url: '#' },
		],
	},
	{
		title: 'guidCenter',
